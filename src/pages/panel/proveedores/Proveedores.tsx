  ...
  return (
    ...
    <>
        ...
        <div className="d-flex gap-2 mb-4">
            <Link to="/proveedores/new" className="btn btn-primary btn-lg">Nuevo</Link>
                ...
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="documento" aria-describedby="Buscador" placeholder='RUC'/>
                        </div>
                    </div>
